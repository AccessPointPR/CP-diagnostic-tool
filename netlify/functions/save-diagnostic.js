...
const DIMS = {
  ...
  conflict: { label: 'Gestion del conflicto',   color: '#993C1D', bg: '#FAECE7' },
  clarity:  { label: 'Claridad',                color: '#854F0B', bg: '#FAEEDA' },
  cohesion: { label: 'Cohesion',                color: '#64B450', bg: '#EBF5E6' },
  psafety:  { label: 'Seguridad psicologica',   color: '#534AB7', bg: '#E5E3FC' },
  impact:   { label: 'Impacto colectivo',       color: '#888780', bg: '#F1EFE8' },
};

const BLOCKERS = {
  trust:    'La confianza es la base de todo. Sin ella, el conflicto se evita, los compromisos son superficiales y la seguridad psicologica es imposible. Este es el punto de palanca mas critico ahora mismo.',
  conflict: 'El equipo evita el conflicto o no lo maneja bien. Eso crea tensiones que van por debajo de la superficie y corroen la colaboracion sin que nadie lo nombre directamente.',
  clarity:  'Hay ambiguedad en objetivos o roles. Cuando cada persona tiene una version distinta de hacia donde vamos o quien decide que, la energia del equipo se fragmenta.',
  cohesion: 'El equipo no ha desarrollado normas solidas ni identidad colectiva. Funciona como grupo de individuos mas que como equipo con personalidad propia.',
  psafety:  'Las personas no se sienten seguras expresando ideas, errores o preocupaciones libremente. Eso limita la innovacion, el aprendizaje colectivo y la confianza profunda.',
  impact:   'El equipo funciona bien internamente pero no ha desarrollado accountability mutuo ni orientacion hacia afuera. Eso limita su influencia organizacional.',
};

const STAGES = [
  { name: 'Forming', sub: 'Conexion antes que contenido', ac: '#888780', al: '#F1EFE8', ad: '#2C2C2A',
    insight: 'Este equipo esta en construccion inicial. La prioridad no es la productividad maxima sino la conexion y la claridad de proposito compartido.',
    recs: [
      { tag: 'Sesion', tc: '#64B450', tb: '#EBF5E6', text: 'Taller de team charter: proposito compartido, expectativas mutuas y acuerdos de trabajo desde cero.' },
      { tag: 'Assessment', tc: '#14A0B4', tb: '#E3F5F8', text: 'Momento ideal para DiSC o StrengthsFinder: conocer estilos individuales antes de que se formen patrones dificiles de cambiar.' },
  ...
  { name: 'Storming', sub: 'Estructura antes que armonia', ac: '#993C1D', al: '#FAECE7', ad: '#4A1B0C',
    insight: 'Este equipo esta en tension activa. Esto es normal, pero necesita ser nombrado y trabajado, no ignorado con actividades recreativas.',
    recs: [
      { tag: 'Sesion', tc: '#64B450', tb: '#EBF5E6', text: 'Taller de estilos de conflicto (Thomas-Kilmann): dar lenguaje neutro al conflicto cambia la dinamica del equipo.' },
      { tag: 'Sesion', tc: '#64B450', tb: '#EBF5E6', text: 'Renegociar acuerdos de trabajo. Muchos conflictos en esta etapa son sintoma de normas que nunca se establecieron.' },
      { tag: 'Precaucion', tc: '#993C1D', tb: '#FAECE7', text: 'Evita actividades puramente recreativas ahora: el equipo las vive como distraccion del conflicto real.' },
    ] },
  { name: 'Norming', sub: 'Sistemas que sostienen la confianza', ac: '#854F0B', al: '#FEF3E2', ad: '#412402',
    insight: 'Este equipo se esta estabilizando. Los avances son reales pero fragiles si no se codifican en normas y rituales explicitos que sobrevivan cambios de personas.',
    recs: [
      { tag: 'Sesion', tc: '#64B450', tb: '#EBF5E6', text: 'Taller de normas y rituales: documentar como trabajamos, procesos de decision y protocolos de comunicacion.' },
      { tag: 'Assessment', tc: '#534AB7', tb: '#E5E3FC', text: 'DiSC o StrengthsFinder colectivo para ver como se complementan los estilos y que fricciones son de personalidad, no de mala fe.' },
      { tag: 'Experiencia', tc: '#854F0B', tb: '#FAEEDA', text: 'Reto de mediana complejidad que refuerce la identidad colectiva: innovacion interna, reto social o experiencia con roles cruzados.' },
    ] },
  { name: 'Performing', sub: 'Reto antes que comodidad', ac: '#64B450', al: '#E1F5EE', ad: '#4A8A39',
    insight: 'Este equipo ejecuta bien. El siguiente reto es pasar de rendimiento a seguridad psicologica real: donde el equipo puede decir verdades dificiles sin costo.',
    recs: [
      { tag: 'Sesion', tc: '#534AB7', tb: '#E5E3FC', text: 'Feedback 360 y retrospectiva profunda: revisar patrones del equipo, no solo resultados de productividad.' },
      { tag: 'Experiencia', tc: '#854F0B', tb: '#FAEEDA', text: 'Reto de alta complejidad con debriefing: hackathon, design sprint o simulacion de crisis.' },
      { tag: 'Assessment', tc: '#14A0B4', tb: '#E3F5F8', text: 'Working Genius (Lencioni) para identificar como cada persona contribuye al trabajo colectivo y donde hay energia desperdiciada.' },
    ] },
  { name: 'High Performing', sub: 'Seguridad psicologica como marcador clave', ac: '#14A0B4', al: '#E6F1FB', ad: '#0C7A8A',
    insight: 'Este equipo ha alcanzado confianza y seguridad psicologica reales. El foco ahora es sostenerlo y expandir su impacto hacia otros equipos y la organizacion.',
    recs: [
      { tag: 'Sesion', tc: '#534AB7', tb: '#E5E3FC', text: 'Auditoria de seguridad psicologica (Edmondson Scale) para identificar zonas de autocensura o asimetria que aun no se ven.' },
      { tag: 'Sesion', tc: '#64B450', tb: '#EBF5E6', text: 'Sesion de vision de legado: que queremos que digan de este equipo en 3 anos. Future-back visioning.' },
      { tag: 'Multiplicador', tc: '#534AB7', tb: '#E5E3FC', text: 'Disenar como este equipo puede servir a otros: comunidad de practica, mentoria a equipos mas jovenes, exportar sus normas.' },
    ] },
  { name: 'Generative', sub: 'Equipos que multiplican impacto hacia afuera', ac: '#534AB7', al: '#EEEDFE', ad: '#26215C',
    insight: 'Este equipo opera mas alla de si mismo. El trabajo ahora es institucionalizar esa generatividad para que sobreviva cambios y rotaciones.',
    recs: [
      { tag: 'Multiplicador', tc: '#534AB7', tb: '#E5E3FC', text: 'Formalizar el rol multiplicador: programas de mentoria, playbooks de cultura o comunidades de practica con otros equipos.' },
      { tag: 'Sesion', tc: '#64B450', tb: '#EBF5E6', text: 'Succession y knowledge transfer: documentar el ADN del equipo para que el conocimiento no se vaya cuando se va una persona.' },
      { tag: 'Experiencia', tc: '#14A0B4', tb: '#E3F5F8', text: 'Proyecto de impacto colectivo: voluntariado significativo, colaboracion con otra organizacion o iniciativa de transferencia de conocimiento.' },
    ] },
];

const GAP_INSIGHT = 'Este equipo tiene fortalezas reales en como se relaciona y opera. Sin embargo, aun no ha construido las practicas deliberadas que convierten esas fortalezas en algo sostenible cuando cambia la gente. Esa es la diferencia entre un equipo naturalmente bueno y uno intencionalmente desarrollado.';
...
function buildPDF({ name, org, stage, stageIndex, scores, gapped }) {
  return new Promise((resolve, reject) => {
    ...
    // TITLE
    let y = 66;
    doc.font('Helvetica-Bold').fontSize(20).fillColor('#282828').text('Diagnostico de Equipo', ML, y, { width: CW });
    y += 28;
    ...
    // DIMENSIONS
    doc.font('Helvetica-Bold').fontSize(9).fillColor('#6B7280').text('PERFIL DE DIMENSIONES', ML, y, { width: CW });
    y += 7;
    ...
    // CRITICAL FACTOR
    doc.font('Helvetica-Bold').fontSize(9).fillColor('#6B7280').text('FACTOR CRITICO', ML, y, { width: CW });
    y += 8;
    ...
    // RECOMMENDATIONS
    doc.font('Helvetica-Bold').fontSize(9).fillColor('#6B7280').text('PROXIMOS PASOS RECOMENDADOS', ML, y, { width: CW });
    y += 7;
    doc.moveTo(ML, y).lineTo(W - ML, y).lineWidth(0.3).stroke('#E5E7EB');
    y += 6;
    st.recs.forEach(rec => {
...
function buildEmailHtml({ name, org, stage, stageIndex, scores }) {
  ...
  return '<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"></head>' +
    ...
    '<p style="margin:0 0 16px;font-size:14px;color:#374151;line-height:1.7">Gracias por completar el <strong>Diagnostico de Equipo CenterPoint</strong>. Adjunto encontraras tu resultado en PDF.</p>' +
    orgLine +
