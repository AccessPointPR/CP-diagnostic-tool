...
const EN_STAGES = [
  { name: 'Forming', sub: 'Connection before content', ac: '#888780', al: '#F1EFE8', ad: '#2C2C2A',
    ...
    recs: [
      ...
      { ef: 'Immersive', ec: '#854F0B', tag: 'Experience',      tc: '#854F0B', tb: '#FAEEDA', text: 'Low emotional-risk collaborative challenge to build shared context before deep trust.' },
    ] },
  ...
  { name: 'Norming', sub: 'Systems that sustain trust', ac: '#854F0B', al: '#FEF3E2', ad: '#412402',
    ...
    recs: [
      ...
      { ef: 'Immersive', ec: '#854F0B', tag: 'Experience',      tc: '#854F0B', tb: '#FAEEDA', text: 'Mid-complexity challenge that reinforces collective identity: internal innovation, social challenge, or cross-role experience.' },
      { ef: 'Immersive', ec: '#854F0B', tag: 'Experience',      tc: '#854F0B', tb: '#FAEEDA', text: 'LEGO Serious Play: build physical models to make visible how the team sees itself, its agreements, and collective identity.' },
    ] },
  { name: 'Performing', sub: 'Challenge before comfort', ac: '#64B450', al: '#E1F5EE', ad: '#4A8A39',
    ...
    recs: [
      ...
      { ef: 'Immersive', ec: '#854F0B', tag: 'Experience',      tc: '#854F0B', tb: '#FAEEDA', text: 'High-complexity challenge with debrief: hackathon, design sprint, or crisis simulation.' },
